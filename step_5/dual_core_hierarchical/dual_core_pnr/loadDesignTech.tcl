...
set init_lef_file "$lef ../core_pnr/core.lef"

# MCMM setup
create_library_set -name WC_LIB -timing "$worst_timing_lib ../core_pnr/core_WC.lib"
create_library_set -name BC_LIB -timing "$best_timing_lib ../core_pnr/core_BC.lib"
